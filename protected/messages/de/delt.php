<?php
  ...
  'Nach dieser Buchung Vorlage herstellen',

  'You are going to create a new template with the following accounts:' => 
  'Man wird eine neue Vorlage mit dem volgem Konto herstellen',

  'Template creation' => 
  'Vorlageherstellung',

  'The template has been correctly saved.' => 
  'Die Vorlage ist korrect abgespeichert worden',

  'The template could not be saved.' => 
  'Die Vorlage konnte nicht abgespeichert sein',

  'A template needs at least two postings.' => 
  'Eine Vorlage braucht wenigstens zwei Posten',
  ...
  'Kontenplanen und Vorlagen',

  'Chart of Accounts, Templates, and Journal Entries' => 
  'Kontenplanen, Vorlagen und Buchungen',
  ...
  'Diese Vorlage abwischen',

  'Are you sure you want to delete this template?' => 
  'Bist du sicher diese Vorlage abzuwischen',

  'The template has been correctly deleted.' => 
  'Die Vorlage ist korrect abgewischt worden',

  'The template could not be deleted.' => 
  'Die Vorlage konnte nicht abgewischt sein',
  ...
  'Die Vorlage wird beim Buchhandlung Erschaffung automatisch benutzt',

  'This template is not used when preparing the statements' => 
  'Die Vorlage wird nicht beim Buchhandlung Erschaffung automatisch benutzt',

  'Apply this template automatically.' => 
  'Diese Vorlage selbsttätig auftragen',
  ...
  'Wenn man diese Vorlage automatisch und virtuell benutzt wird, soll man das benutzen, immer wenn ein Auszug vorbereitet wird.',
