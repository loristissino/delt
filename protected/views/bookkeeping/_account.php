<span class="j<?php echo $amount>0 ? 'debit':'credit' ?>"><?php echo CHtml::link($account->name, $this->createUrl('bookkeeping/ledger', array('id'=>$account->id, 'post'=>$post->id)), array('class'=>'hiddenlink')) ?>
