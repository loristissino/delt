...
<?php foreach($firms as $firm): ?>
  <p class="firm">
    <span class="name"><?php echo CHtml::link($firm, $this->createUrl('firm/fork', array('slug'=>$firm->slug)), array('title'=>Yii::t('delt', 'Fork the firm «{firm}»', array('{firm}'=>$firm->name)))) ?></span><br />
